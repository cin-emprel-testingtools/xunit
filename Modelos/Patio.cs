using Cin.Estacionamento.Cin.Estacionamento.Modelos;
using Cin.Estacionamento.Modelos;
using System;
...
namespace Cin.Estacionamento.Modelos
{
    public class Patio
    {
        ...
        private string GerarTicket(Veiculo veiculo){
            ...
            string ticket = "### Ticket Estacionameno Cin ###" +
